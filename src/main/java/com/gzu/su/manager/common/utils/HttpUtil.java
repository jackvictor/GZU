...
public class HttpUtil {
	...
	public static String doGet(String url, Map<String, String> param) {
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				resultString = EntityUtils.toString(response.getEntity(), Constants.DEF_ENCODE);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static String doPost(String url, Map<String, String> param) {
		...
		try {
			...
			if (param != null) {
				...
				// 模拟表单
				UrlEncodedFormEntity entity = new UrlEncodedFormEntity(paramList, Constants.DEF_ENCODE);
	...
	public String sendXMLDataByPost(String url, String xmlParam, String xmlData) throws Exception {
		...
		post.setEntity(new UrlEncodedFormEntity(parameters, Constants.DEF_ENCODE));
